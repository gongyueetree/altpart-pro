...
/** 同义词组：组内任意名称视为同一参数 */
const SYNONYMS = [
  ["等效输入噪声", "输入噪声密度", "输入参考噪声", "噪声密度", "inputnoisedensity", "inputreferrednoise", "noisedensity", "envoltagenoise"],
  ...
  ["增益带宽积", "带宽", "gbw", "gainbandwidth", "gainbandwidthproduct", "bandwidth", "3dbbandwidth"],
  ["压摆率", "slewrate", "sr"],
